...
function Addproduct() {
  ...
  const { imgUrl, setImgUrl, handleImageChange, imgFile, firebaseBase64UploadUrl,setFirebaseBase64UploadUrl } =
    usePreviewImg();
        ...
        <div>
          ...
          <form className="grid gap-4" onSubmit={(e) => handleAddProduct(e)}>
            <div className="grid gap-2">
              ...
              <Input id="name" type="text" placeholder="Enter product name" value={name} onChange={(e:ChangeEvent<HTMLInputElement>)=>setName(e.target.value)}/>
            </div>
            <div className="grid gap-2">
